...
{
    //This script is specifically for the enemy's troops.

    public static EnemyPooler instance; //Singleton
    ...
    public List<Pool> pools; //A pool for each enemy troop
    public Dictionary<string, Queue<GameObject>> poolDict; //A dict so we can spawn a troop based on enemy troop name
